...
directory="C:\\Users\\Nishara\\Desktop\\FRAS\\"
...
class facerecognitionsystem:
    def __init__(self, FR_wind):
        ...
        sub_combo["values"]=("Select Subject","Dummy Attendance","PE","IR")
        sub_combo.current(0)
    ...
    def markA(self,namelist):
        ...
        if sub!="Select Subject":
            ...
            wb.save("C:/Users/Nishara/Desktop/env/FRAS/Attendance/sheet_"+sub+".xlsx")
